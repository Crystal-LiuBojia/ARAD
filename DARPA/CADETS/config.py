...
raw_dir = "./cadets_e3_data/"

# The directory to save all artifacts
artifact_dir = "./CADETS_E3/artifact/"
...
host = 'localhost'  #'/var/run/postgresql/'
# host = None
...
node_embedding_dim = 16#64# 32 #16
...
time_window_size = 60000000000 * 10
