...
def test(inference_data,
    ...
    #for batch in seq_batches(inference_data, batch_size=BATCH):
    for batch in tqdm(seq_batches(inference_data, batch_size=BATCH), desc="Inference"):
...
def load_data():
    ...
    # Testing set
    graph_4_6 = torch.load(graphs_dir + "/graph_4_6.TemporalData-160.simple").to(device=device)
...
if __name__ == "__main__":
    ...
    # load trained model
    memory, gnn, link_pred, neighbor_loader = torch.load(f"{models_dir}/models_20250523_073317.pt",map_location=device)
    ...
    #      path=artifact_dir + "graph_4_3_10min")
    # print("graph_4_4")
    ...
    #      neighbor_loader=neighbor_loader,
    #      nodeid2msg=nodeid2msg,
    #      path=artifact_dir + "graph_4_4_10min")
    # print("graph_4_5")
    ...
    #      neighbor_loader=neighbor_loader,
    #      nodeid2msg=nodeid2msg,
    #      path=artifact_dir + "graph_4_5_10min")
    print("graph_4_6")
    test(inference_data=graph_4_6,
         ...
         neighbor_loader=neighbor_loader,
         nodeid2msg=nodeid2msg,
         path=artifact_dir + "graph_4_6_10min_adversarial_160")
    # print("graph_4_7")
    ...
    #      neighbor_loader=neighbor_loader,
    #      nodeid2msg=nodeid2msg,
    #      path=artifact_dir + "graph_4_7_10min")
